...
namespace Tests
{
    ...
    {
        private const string Content = "client_id=client&client_secret=secret&scope=products.read&grant_type=client_credentials";
        private readonly Uri tokenUri = new Uri("http://localhost:5000/connect/token");
